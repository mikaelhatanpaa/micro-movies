...
type Registry interface {
	...
	// ServiceAdresses returns the list of addresses of
...
// ErrNotFound is returned when no service adresses are
// found.
var ErrNotFound = errors.New("no service adresses found")

// GenerateInstanceID generates a pseudo-random service
// instance identifier, using a service name
// suffuxed by dash and a random number.
